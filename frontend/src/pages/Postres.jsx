...
export default function Postres() {
  ...
  const postres = [
    { id: 1, name: "Brownie con helado", price: 12900, image: "" },
    { id: 2, name: "Tiramisú", price: 15900, image: "" },
    { id: 3, name: "Cheesecake de fresa", price: 14900, image: "" },
    { id: 4, name: "Cupcake de vainilla", price: 7900, image: "" },
    { id: 5, name: "Malteada de chocolate", price: 11900, image: "" },
    { id: 6, name: "Sundae especial", price: 9900, image: "" },
    { id: 7, name: "Crepes de nutella", price: 16900, image: "" },
    { id: 8, name: "Helado triple sabor", price: 10900, image: "" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <h1 className="text-4xl font-bold mb-6">Sección de postres</h1>
