...
export default function Hamburguesas() {
  ...
  const hamburguesas = [
    { id: 1, name: "Hamburguesa clásica", price: 15900, image: "" },
    { id: 2, name: "Hamburguesa doble carne", price: 22900, image: "" },
    { id: 3, name: "Hamburguesa BBQ", price: 19900, image: "" },
    { id: 4, name: "Hamburguesa con queso", price: 17900, image: "" },
    { id: 5, name: "Hamburguesa pollo crispy", price: 20900, image: "" },
    { id: 6, name: "Hamburguesa mexicana", price: 23900, image: "" },
    { id: 7, name: "Hamburguesa vegetariana", price: 18900, image: "" },
    { id: 8, name: "Hamburguesa especial familiar", price: 32900, image: "" },
  ];

  const hamburguesasFiltradas = hamburguesas
    .filter((h) =>
      h.name.toLowerCase().includes(searchQuery.toLowerCase())
    )
    .sort((a, b) => {
      if (ordenar === "precio") return a.price - b.price;
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <h1 className="text-4xl font-bold mb-6">Sección de hamburguesas</h1>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-gray-600 mb-6">
            Se encontraron{" "}
            <strong>{hamburguesasFiltradas.length}</strong> hamburguesa(s)
          </p>

          {hamburguesasFiltradas.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No se encontraron 😞</p>
              <button
                onClick={() => navigate("/")}
