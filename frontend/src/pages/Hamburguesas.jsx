...
export default function Hamburguesas() {
  ...
  const hamburguesas = [
    { id: 1, name: "Hamburguesa sencilla", price: 12900, image: "" },
    { id: 2, name: "Hamburguesa doble carne", price: 18900, image: "" },
    { id: 3, name: "Hamburguesa con queso", price: 14900, image: "" },
    { id: 4, name: "Hamburguesa triple", price: 24900, image: "" },
    { id: 5, name: "Hamburguesa especial", price: 19900, image: "" },
    { id: 6, name: "Hamburguesa con tocino", price: 16900, image: "" },
    { id: 7, name: "Hamburguesa a lo pobre", price: 21900, image: "" },
    { id: 8, name: "Hamburguesa del chef", price: 25900, image: "" },
  ];

  const hamburguesisFiltradas = hamburguesas
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="mb-6">
            <h1 className="text-4xl font-bold">Sección de hamburguesas</h1>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-gray-600 mb-6">
            Se encontraron <strong>{hamburguesisFiltradas.length}</strong> hamburguesa(s)
          </p>

          {hamburguesisFiltradas.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {hamburguesisFiltradas.map((hamburguesa) => (
                <div
                  key={hamburguesa.id}
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-2xl font-bold text-gray-900 mb-4">
                      ${hamburguesa.price.toLocaleString('es-CO')}
                    </p>
                    <button
