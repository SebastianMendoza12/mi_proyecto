...
export default function Acompañantes() {
  ...
  const acompañantes = [
    { id: 1, name: "Papas fritas pequeñas", price: 5900, image: "" },
    { id: 2, name: "Papas fritas medianas", price: 8900, image: "" },
    { id: 3, name: "Papas fritas grandes", price: 11900, image: "" },
    { id: 4, name: "Aros de cebolla", price: 9900, image: "" },
    { id: 5, name: "Alitas de pollo BBQ", price: 12900, image: "" },
    { id: 6, name: "Nuggets de pollo (6 piezas)", price: 10900, image: "" },
    { id: 7, name: "Tabla de quesos y embutidos", price: 18900, image: "" },
    { id: 8, name: "Camote frito", price: 7900, image: "" },
  ];

  const acompañantesFiltrados = acompañantes
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="mb-6">
            <h1 className="text-4xl font-bold">Sección de acompañantes</h1>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-gray-600 mb-6">
            Se encontraron <strong>{acompañantesFiltrados.length}</strong> acompañante(s)
          </p>
              ...
              {acompañantesFiltrados.map((acompañante) => (
                ...
                >
                  <div className="w-full h-48 bg-gray-200 flex items-center justify-center text-4xl">
                    {acompañante.image ? (
                      <img
                        src={acompañante.image}
                        alt={acompañante.name}
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-2xl font-bold text-gray-900 mb-4">
                      ${acompañante.price.toLocaleString('es-CO')}
                    </p>
                    <button
