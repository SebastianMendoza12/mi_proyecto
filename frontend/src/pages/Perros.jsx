...
export default function Perros() {
  ...
  const perros = [
    { id: 1, name: "Perro sencillo", price: 8900, image: "" },
    { id: 2, name: "Perro con queso", price: 10900, image: "" },
    { id: 3, name: "Perro a lo pobre", price: 11900, image: "" },
    { id: 4, name: "Perro especial con tocino", price: 13900, image: "" },
    { id: 5, name: "Perro doble", price: 14900, image: "" },
    { id: 6, name: "Perro super cargado", price: 16900, image: "" },
    { id: 7, name: "Perro picante", price: 12900, image: "" },
    { id: 8, name: "Perro gourmet del chef", price: 18900, image: "" },
  ];

  const perrosFiltrados = perros
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="mb-6">
            <h1 className="text-4xl font-bold">Sección de perros calientes</h1>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-gray-600 mb-6">
            Se encontraron <strong>{perrosFiltrados.length}</strong> perro(s) caliente(s)
          </p>

          {perrosFiltrados.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">
                No se encontraron perros calientes 😞
              </p>
              <button
                onClick={() => navigate("/")}
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-2xl font-bold text-gray-900 mb-4">
                      ${perro.price.toLocaleString('es-CO')}
                    </p>
                    <button
